...
public class DefaultMaps {
	...
	static {
		...
		obstacles.add(new EllipticalObstacle(d.getWidth() * 0.2, d
				...
				.getHeight() / 2), new Color(0, 128, 255),Math.PI*3/8, true));
		...
		obstacles.add(new RectangularObstacle(d.getWidth() * 0.2, d
				...
				.getHeight() / 2), new Color(0, 128, 255),Math.PI/4, true));
		...
		obstacles = new ArrayList<IObstacle>(1);
		obstacles.add(new RectangularObstacle(d.getWidth()*0.5, d.getHeight() * 0.04, new Position(d.getWidth()*0.3, d.getHeight()*0.2), new Color(0, 128, 255),0, true));
		obstacles.add(new RectangularObstacle(d.getWidth()*0.5, d.getHeight() * 0.04, new Position(d.getWidth()*0.7, d.getHeight()*0.4), new Color(0, 128, 255),0, true));
		obstacles.add(new RectangularObstacle(d.getWidth()*0.5, d.getHeight() * 0.04, new Position(d.getWidth()*0.3, d.getHeight()*0.6), new Color(0, 128, 255),0, true));
		obstacles.add(new RectangularObstacle(d.getWidth()*0.5, d.getHeight() * 0.04, new Position(d.getWidth()*0.7, d.getHeight()*0.8), new Color(0, 128, 255),0, true));
		rivers_map = new SimulationMap(obstacles, "Rivers");
		obstacles = new ArrayList<IObstacle>(3);
		obstacles.add(new RectangularObstacle(d.getWidth() * 0.5, d.getHeight() * 0.225, new Position(d.getWidth() * 0.5, d.getHeight() * 0.225), new Color(25, 25, 25),0, true));
		obstacles.add(new RectangularObstacle(d.getWidth() * 0.5, d.getHeight() * 0.225, new Position(d.getWidth() * 0.5, d.getHeight() * 0.775), new Color(25, 25, 25),0, true));
