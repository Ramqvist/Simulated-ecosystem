...
public class NEWSettingsMenuView extends JFrame {
    ...
    public final JButton buttonStart; //kanske den hï¿½r bara ska vara apply, och sen startar man frï¿½n mainwindow?
    ...
    /*
     ...
     sliderDelayLength.setSnapToTicks(true);  //kolla upp vad de hï¿½r gï¿½r...
     ...
     sliderNoOfIterations.setEnabled(false); //TODO: hï¿½ll koll pï¿½ den hï¿½r
